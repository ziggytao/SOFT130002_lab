...
function showWindowHref(){
	var str= url.value;
	var start = str.search("name=");
	var end = str.substring(start,str.length).search("&") + start;
	url_result.value = str.substring(start+5,end);
}
...
function arrSameStr(){
	...
	result.value = "The most character is:" + max_ch + " times:" + max;
}
